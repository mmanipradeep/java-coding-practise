...
public class BatchConcatBenchMark {
	...
	public static void concatByPlusBy100(StrState strState, Blackhole blackhole) {
		String concatString = strState.token + strState.token + strState.token + strState.token + strState.token
				+ strState.token + strState.token + strState.token + strState.token + strState.token + strState.token
				+ strState.token + strState.token + strState.token + strState.token + strState.token + strState.token
				+ strState.token + strState.token + strState.token + strState.token + strState.token + strState.token
				+ strState.token + strState.token + strState.token + strState.token + strState.token + strState.token
				+ strState.token + strState.token + strState.token + strState.token + strState.token + strState.token
				...
				+ strState.token + strState.token + strState.token + strState.token + strState.token + strState.token
				+ strState.token + strState.token + strState.token + strState.token + strState.token + strState.token
				+ strState.token + strState.token + strState.token + strState.token + strState.token;
	...
	public static void main(String[] args) throws Exception {
		Options options = new OptionsBuilder().include(BatchConcatBenchMark.class.getSimpleName()).threads(1)
