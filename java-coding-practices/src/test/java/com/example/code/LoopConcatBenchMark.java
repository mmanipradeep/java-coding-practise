...
public class LoopConcatBenchMark {
	...
	public static void concatByConcat(int iterations, Blackhole blackhole) {
		String concatString = "";
		for (int n = 0; n < iterations; n++)
			concatString = concatString.concat(TOKEN);
		blackhole.consume(concatString);
	}
	...
	public static void concatByJoin(int iterations, Blackhole blackhole) {
		String concatString = "";
		for (int n = 0; n < iterations; n++)
			concatString = String.join("", concatString, TOKEN);
		blackhole.consume(concatString);
	}
	...
	public static void concatByFormat(int iterations, Blackhole blackhole) {
		String concatString = "";
		for (int n = 0; n < iterations; n++)
			concatString = String.format("%s%s", concatString, TOKEN);
		blackhole.consume(concatString);
	}
	...
	public static void main(String[] args) throws Exception {
		Options options = new OptionsBuilder().include(LoopConcatBenchMark.class.getSimpleName()).threads(1)
